...
let hexagons = svg.append("g")
    ...
    d3.select(".title_radar").text(`${genre_list[0]}`).classed("text-center", true)
    ...
    .on("mouseover", function(d,i) {
        ...
        d3.select(".title_radar").text(`${genre_list[selected_row]}`)
...
//  TEXTO PARA CADA CÍRCULO DENTRO DEL RADAR
